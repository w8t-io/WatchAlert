...
func SelectPromRules(ruleGroup string) SearchRules {
...
func CreatePromRule(ruleGroup string, ruleBody io.ReadCloser) error {
...
func DeletePromRule(ruleGroup, ruleName string) error {
...
func UpdatePromRule(ruleGroup, ruleName string, ruleBody io.ReadCloser) (AlertRules, error) {

	var (
		ruleConfigFile, newRuleConfig AlertRules
	)
	ruleFilePath := globals.Config.Prometheus.RulePath + "/" + ruleGroup + ".yaml"
...
func GetPromRuleData(ruleGroup, ruleName string) (Rules, error) {
